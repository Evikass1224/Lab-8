...
namespace Planner
{
    ...
    class TaskManager
    {
        public void Menu(out bool exitFlag)
        {
            ...
            exitFlag = false;  //флаг для проверки ввода "0" для выхода
        ...
        private void AddTask()
        {
            ...
            Task task = new Task(0, title, description, dateCompletion, false);
        ...
        private void DeleteTask()
        {
            ...
            while (!validId)
            {
                ...
                validId = uint.TryParse(Console.ReadLine(), out id);
